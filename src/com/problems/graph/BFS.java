...
public class BFS {
    public static void main(String[] args) {
        ...
        System.out.println(graph.breadthFirstSearch(new ArrayList<>()));
    }

    static class Node {
        String name;
        List<BFS.Node> children = new ArrayList<>();
        ...
        public BFS.Node addChild(String name) {
            BFS.Node child = new BFS.Node(name);
            children.add(child);
            return this;
        }
    }
